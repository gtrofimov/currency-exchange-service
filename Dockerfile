...
ENTRYPOINT ["java", '-javaagent:"/monitor/agent.jar"=settings="/monitor/agent.properties",runtimeData=/monitor/runtime_coverage",autostart=false,collectTestCoverage=true', "-jar", "currency-exchange-service.jar"]